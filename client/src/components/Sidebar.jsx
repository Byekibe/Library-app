            ...
            <div className="flex-shrink-0 p-3" style={{width: "280px"}}>
                ...
                <li className="mb-1">
                    ...
                    <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        ...
                        <li><a href="#" className="link-body-emphasis d-inline-flex text-decoration-none rounded">About</a></li>
                        <li><a href="#" className="link-body-emphasis d-inline-flex text-decoration-none rounded">Contact</a></li>
                    </ul>
                    </div>
                </li>
                <li className="mb-1">
                    ...
                    <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><Link to="/science" className="link-body-emphasis d-inline-flex text-decoration-none rounded">Science</Link></li>
                        <li><Link to="history" className="link-body-emphasis d-inline-flex text-decoration-none rounded">History</Link></li>
